...
const Intro = () => {
  return (
    ...
    <div className='flex flex-col'>
        <span className='text-6xl font-Heading'>Cobi Reeves </span>
        <span className='text-3xl font-Heading'>Full stack Developer </span>
        <span className='text-2xl font-Heading'>Nice to meet you! </span>
    </div>
    <div className='flex bg-purple-100 w-2/3 rounded-3xl mx-auto mt-5'>
        <div className='w-10/12 p-10 flex flex-col'>
        ...
        <div className='w 1/4 p-5'>
            <img src="/Cobi.png" alt="Portrait" width='200px' height='200px' />
        </div>
    </div>
