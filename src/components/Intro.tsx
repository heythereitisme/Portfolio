  ...
  return (
    ...
    <div className='flex bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 w-2/3 rounded-3xl mx-auto my-5'>
        <div className='p-10 flex flex-col'>
            ...
            <span className='sm:text-lg font-Para leading-relaxed mt-10 xsm:text-md'> 
    ...
    <div className='gap-20 mt-10 xl:flex lg:grid lg:grid-cols-2 xsm:grid-cols-1'>
      ...
      <img src={JavascriptLogo} alt="React logo" height={100} width={100} className='mx-auto'/>
      <img src={MongoDBLogo} alt="React logo" height={100} width={200} className='mx-auto'/>
      <img src={NodeJSLogo} alt="React logo" height={100} width={150} className='mx-auto lg:mr-auto'/>
    </div>
    </div>
  )
}
